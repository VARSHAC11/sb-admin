...
import CanvasJSReact from '../src/Component/canvas';
import { Components, Buttons, Cards} from "../src/Component";
import { Utilities, Navcolors, Borders, Animations, Other } from "./Utilities";
import { Pages, Login, Errorpage, Blankpage } from "../src/Page";
        ...
        <div className="wholepage">
          ...
          <div>
            <div className="topnavbar">
              ...
              <div className="topnavbellicon">
              <Badge badgeContent={5} max={3} {...defaultProps} >
              <FontAwesomeIcon icon={faBell} />
              </Badge>
                </div>
                <div className="topnavbellicon"><Badge badgeContent={7} color="secondary">
                 <MailIcon />
                 </Badge></div>
                
                <div className="topnavusername ">Douglas McGee       
                </div>
                <img className="dpimg" src="https://startbootstrap.github.io/startbootstrap-sb-admin-2/img/undraw_profile.svg"/>
            ...
            <div className="coyrightcontainer">Copyright © Varsha Website 2021</div>
          </div>
